...
const EMAIL_SUBJECT_PREFIX = "[Technical team] Machine reservation - ";
const EMAIL_TEMPLATE_DOC_URL = 'https://docs.google.com/document/d/1_mKrVfYsQ2CoMXc6kqLZdWYB-kiwqZoO6Ewsq2_43iE/edit?usp=sharing';
...
function onFormSubmit(e) {
    ...
    let equipment = responses.Equipment[0];
    ...
    // If the equipment need reservation, send an email to the recipient.
    var status = '';
    if (equipment.includes("Reservation")) {
        MailApp.sendEmail({
            to: RECIPIENT_TechnicalManager + ',' + applicantEmail,
            //to: RECIPIENT,
            subject: EMAIL_SUBJECT_PREFIX + equipment.substring(14),
